/* it is showing error because u r trying to store constant string(like “abc” ) to char *.

to rectify it typecast ur constant string to char * .
something like (char*) “abc” */
#include <iostream>
#include<cstring>
using namespace std;
